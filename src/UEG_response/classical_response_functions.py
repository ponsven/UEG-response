...
def _Layden_ideal_quadratic_response(k1_vec, omega_1, k2_vec, omega_2, n, beta, m, dc=1e-4, eta_pol=1e-4, reltol=1e-6, abstol=1e-8):
    ...
    first = np.dot(k1_vec, k2_vec) * (generlized_plasma_dispersion_function_m_n(a1, b1, s, 1.0, 0, 3, dc=dc, eta_pol=eta_pol, reltol=reltol, abstol=abstol)
                                    + generlized_plasma_dispersion_function_m_n(a2, b2, s, 1.0, 0, 3, dc=dc, eta_pol=eta_pol, reltol=reltol, abstol=abstol) )
    ...
    tmp = ( generlized_plasma_dispersion_function_m_n(a1t, b1t, rt, sgn_rt, 0, 1, dc=dc, eta_pol=eta_pol, reltol=reltol, abstol=abstol) 
          + generlized_plasma_dispersion_function_m_n(a2t, b2t, rt, sgn_rt, 0, 1, dc=dc, eta_pol=eta_pol, reltol=reltol, abstol=abstol)
          - generlized_plasma_dispersion_function_m_n(a1t, b1t, s1, 1.0, 0, 1, dc=dc, eta_pol=eta_pol, reltol=reltol, abstol=abstol)
          - generlized_plasma_dispersion_function_m_n(a2t, b2t, s1, 1.0, 0, 1, dc=dc, eta_pol=eta_pol, reltol=reltol, abstol=abstol)
        ) / (rt - s1)

    tmp2 = ( tmp - generlized_plasma_dispersion_function_m_n(a1t, b1t, s1, 1.0, 0, 2, dc=dc, eta_pol=eta_pol, reltol=reltol, abstol=abstol)
                 - generlized_plasma_dispersion_function_m_n(a2t, b2t, s1, 1.0, 0, 2, dc=dc, eta_pol=eta_pol, reltol=reltol, abstol=abstol)
           ) / (rt - s1)
    ...
    tmp = ( generlized_plasma_dispersion_function_m_n(a1b, b1b, rb, sgn_rb, 0, 1, dc=dc, eta_pol=eta_pol, reltol=reltol, abstol=abstol) 
          + generlized_plasma_dispersion_function_m_n(a2b, b2b, rb, sgn_rb, 0, 1, dc=dc, eta_pol=eta_pol, reltol=reltol, abstol=abstol)
          - generlized_plasma_dispersion_function_m_n(a1b, b1b, s2, 1.0, 0, 1, dc=dc, eta_pol=eta_pol, reltol=reltol, abstol=abstol)
          - generlized_plasma_dispersion_function_m_n(a2b, b2b, s2, 1.0, 0, 1, dc=dc, eta_pol=eta_pol, reltol=reltol, abstol=abstol)
        ) / (rb - s2)

    tmp2 = ( tmp - generlized_plasma_dispersion_function_m_n(a1b, b1b, s2, 1.0, 0, 2, dc=dc, eta_pol=eta_pol, reltol=reltol, abstol=abstol)
                 - generlized_plasma_dispersion_function_m_n(a2b, b2b, s2, 1.0, 0, 2, dc=dc, eta_pol=eta_pol, reltol=reltol, abstol=abstol)
           ) / (rb - s2)
